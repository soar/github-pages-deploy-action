...
exports.suppressSensitiveInformation = exports.hasRequiredParameters = exports.generateFolderPath = exports.generateRepositoryPath = exports.generateTokenType = exports.isNullOrUndefined = void 0;
...
exports.generateFolderPath = (action, key) => {
    const folderName = action[key];
    const folderPath = path_1.default.isAbsolute(folderName)
        ? folderName
